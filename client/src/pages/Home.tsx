...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col font-sans">
            ...
            <div className="text-center py-16 bg-card border border-dashed border-secondary/20 rounded-3xl max-w-md mx-auto space-y-4">
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs md:text-sm text-muted-foreground font-sans px-6">
                  We couldn't find any bird cards matching your search. Try
                  adjusting your filters or be the first to log this species!
                </p>
              </div>
              <Button
                onClick={() => setIsAddOpen(true)}
      ...
      <section
        id="story"
        className="py-16 md:py-24 bg-background border-t border-secondary/10 relative overflow-hidden"
      >
        ...
        <div className="container grid md:grid-cols-12 gap-8 md:gap-16 items-center max-w-5xl mx-auto relative z-10">
            ...
            <div className="aspect-3/4 rounded-3xl overflow-hidden border border-secondary/20 shadow-xl relative">
              ...
              <div className="absolute bottom-6 left-6 right-6 text-white space-y-1">
                ...
                <p className="text-xs font-sans opacity-90">
                  Where the migratory journey concludes each winter.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="md:col-span-7 space-y-6 md:space-y-8 text-left">
            ...
            <div className="space-y-4 font-sans text-sm md:text-base text-muted-foreground leading-relaxed">
              <p>
                Every autumn, as the chill of winter begins to sweep across
                Europe, millions of birds feel the ancient call of the south.
                They embark on an epic journey along the{" "}
                <strong>African-Eurasian Flyway</strong>, flying over seas,
                deserts, and mountains to reach the warm, life-giving
                sanctuaries of Kenya.
              </p>
              <p>
                <strong>AviKenya</strong> was founded by a community of European
                birdwatching enthusiasts who fell in love with Kenya's rich,
                diverse birdlife. We wanted to build a bridge between these two
                worlds—a place where people can share their awe, connect with
                fellow nature lovers, and preserve the delicate ecosystems that
                support these incredible travelers.
              </p>
              <p className="font-serif italic text-foreground font-medium text-base md:text-lg">
                “To watch a bird migrate is to witness a thread of life being
                woven across the globe, connecting countries, cultures, and
                hearts.”
              </p>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4 pt-4 border-t border-border/60 text-center">
              <div>
                ...
                <p className="text-[10px] md:text-xs text-muted-foreground font-sans uppercase tracking-wider mt-1">
                  Kenya Bird Species
                </p>
              </div>
              <div>
      ...
      <footer
        id="community"
        className="bg-primary text-primary-foreground py-12 md:py-16 border-t border-primary/20"
      >
